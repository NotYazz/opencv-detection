...
namespace overlay
{
    ...
    static float aspectRatio = 16.0f / 10.0f;
...
void overlay::SetupWindow()
{
    ...
    overlay::Window = CreateWindowExA(NULL, "recoil", "recoil", WS_POPUP, Rect.left, Rect.top, Rect.right, Rect.bottom, NULL, NULL, wcex.hInstance, NULL);
